...
import { PrismaClient } from "./generated"; // Caminho para a pasta que o Generator criou
import pg from "pg";
import { PrismaPg } from "@prisma/adapter-pg";

// 1. Prepara a conexão bruta com o Postgres (Neon)
...
// 3. Inicia o cliente usando o adaptador em vez de apenas a URL
...
async function seedDatabase() {
  try {
    ...
    console.log(">>> Iniciando o Seed no Neon...");

    // Limpeza opcional: se quiser limpar o banco antes de popular, descomente as linhas abaixo:
